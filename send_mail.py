...
with smtplib.SMTP_SSL('smtp.gmail.com', 465) as mail:
    ...
    # or a list or emails or a comma seperated string or emails
    messege['To'] = 'RECIVER'
    messege['From'] = email
    messege['Subject'] = 'Testing smtp mail'
    messege.set_content(
        'This is a test of the smtp python email sending\nwith an attachment')

    # adding an attachment
    file = open('FILE', 'rb')
    attachment = file.read()
    messege.add_attachment(attachment, maintype='application',
                           subtype='octet-stream', filename='regex cheatsheet.png')
